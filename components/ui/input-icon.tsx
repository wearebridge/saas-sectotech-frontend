  ...
  ({ className, type, StartIcon, ButtonIcon, ...props }, ref) => {
    return (
      ...
      >
        ...
        <input
          type={type}
          className="flex h-9 w-full bg-transparent px-1 py-1 text-base placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed md:text-sm"
          ref={ref}
          {...props}
        />
        {ButtonIcon && (
